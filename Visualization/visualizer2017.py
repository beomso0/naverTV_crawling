...
def opener(url):
    ...
    pand['qt1'] = pand.date.apply(lambda e: datetime.datetime(2017,1,1) <= e < datetime.datetime(2017,4,1))
    pand['qt2'] = pand.date.apply(lambda e: datetime.datetime(2017,4,1) <= e < datetime.datetime(2017,7,1))
    pand['qt3'] = pand.date.apply(lambda e: datetime.datetime(2017,7,1) <= e < datetime.datetime(2017,10,1))
    pand['qt4'] = pand.date.apply(lambda e: datetime.datetime(2017,10,1) <= e < datetime.datetime(2018,1,1))

    return pand


#open files
mudo = opener(r"C:\Users\bumso\datajournalism-2018\datajournalism-team-1\Beomsoo\navertv_json_data\2017\mudo_2017.json")
# mudo = mudo.iloc[1:]   #무도는 2009년 데이터가 하나 포함되어 있어서 그 데이터 제거해줌.
nahonja = opener(r"C:\Users\bumso\datajournalism-2018\datajournalism-team-1\Beomsoo\navertv_json_data\2017\nahonja_2017.json")
bokga = opener(r"C:\Users\bumso\datajournalism-2018\datajournalism-team-1\Beomsoo\navertv_json_data\2017\bokga_2017.json")
radio = opener(r"C:\Users\bumso\datajournalism-2018\datajournalism-team-1\Beomsoo\navertv_json_data\2017\radio_2017.json")
...
def bar_graph(data_list, category):
    ...
    plt.title(category + "_2017_bar")
    plt.xticks(rotation = 90)
    plt.savefig(category + "_2017_bar")
    plt.show()
