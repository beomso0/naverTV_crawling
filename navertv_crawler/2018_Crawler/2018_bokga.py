...
class Naver_Crawler:
    ...
    def list_crawl(self) :
        while self.in_list == True:
            ...
            try : 
                if (data_dict['date'] == '2018.12.09.') and (data_dict['order_in_list'] == 14) :
                    #2018년 크롤링 완료 시 완료 메시지 출력 및 json 파일 작성
                    print('크롤링이 완료됐습니다.')
                    with open('bokga_2018.json', 'w', encoding="utf-8") as make_file:
...
#MBC 복면가왕 2018년 1화 네이버 tv 링크 

first_url = 'https://tv.naver.com/v/2515649/list/180993'   
