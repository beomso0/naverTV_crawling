...
class Naver_Crawler:
    ...
    def list_crawl(self) :
        while self.in_list == True:
            ...
            is_lee = lee_name in driver.find_element_by_xpath("//h3[@class = '_clipTitle']").text   
            ...
            if "예고" in title :
                ...
                try:
                    date =  driver.find_element_by_xpath('//*[@id="clipInfoArea"]/div[4]/div/dl/dd[2]').text
            ...
            try : 
                if (data_dict['date'] == '2018.12.08.') and (data_dict['order_in_list'] == 16) :
                    #2018년 크롤링 완료 시 완료 메시지 출력 및 json 파일 작성
                    print('크롤링이 완료됐습니다.')
                    with open('jeoncham_2018.json', 'w', encoding="utf-8") as make_file:
...
#MBC 전참시 2018년 1화 네이버 tv 링크 

first_url = 'https://tv.naver.com/v/2786824/list/194784'   
