    ...
    def list_crawl(self) :
        while self.in_list == True:
            ...
            if "예고" in title :
                ...
                # if date_strp >= datetime.strptime("2016-01-01", "%Y-%m-%d"):
                #     #2017년 크롤링 완료 시 완료 메시지 출력 및 json 파일 작성
                #     print('크롤링이 완료됐습니다.')
                #     with open('malitel_2015.json', 'w', encoding="utf-8") as make_file:
            ...
            try : 
                if (data_dict['date'] == '2015.12.27.') and (data_dict['order_in_list'] == 6) :
                    #2018년 크롤링 완료 시 완료 메시지 출력 및 json 파일 작성
                    print('크롤링이 완료됐습니다.')
                    with open('malitel_2016.json', 'w', encoding="utf-8") as make_file:
                        json.dump(self.data_list, make_file, ensure_ascii=False, indent = '\t')
                    exit()
            except KeyError :
                pass
            ...
            try :
                if (data_dict['date'] == '2015.07.05.') and (data_dict['order_in_list'] == 22) :
                    driver.get('https://tv.naver.com/v/451361/list/42234')
            except KeyError :
                pass
...
#MBC 마리텔 2015년 1화 네이버 tv 링크
first_url = 'https://tv.naver.com/v/373212/list/34238'
