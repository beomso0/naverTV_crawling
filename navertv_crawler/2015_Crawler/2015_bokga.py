...
class Naver_Crawler:
    ...
    def list_crawl(self) :
        while self.in_list == True:
            ...
            is_kim2 = kim2_name in driver.find_element_by_xpath("//h3[@class = '_clipTitle']").text           
            ...
            if "예고" in title :
                ...
                if date_strp >= datetime.strptime("2016-01-01", "%Y-%m-%d"):
                    #2015년 크롤링 완료 시 완료 메시지 출력 및 json 파일 작성
                    print('크롤링이 완료됐습니다.')
                    with open('bokga_2015.json', 'w', encoding="utf-8") as make_file:
...
#MBC 복면가왕 2015년 2화 네이버 tv 링크 
'''
--> 추후에 1회 정보 추가 필요!!!!  1화 링크 : https://tv.naver.com/v/367278/list/33656
'''

first_url = 'https://tv.naver.com/v/373535/list/34265' 
