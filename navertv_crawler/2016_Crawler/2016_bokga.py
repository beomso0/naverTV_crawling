    ...
    def list_crawl(self) :
        while self.in_list == True:
            ...
            if "예고" in title :
                ...
                # if (date_strp != datetime.strptime("2018-10-19", "%Y-%m-%d")) and  (date_strp >= datetime.strptime("2017-01-01", "%Y-%m-%d")):
            ...
            try : 
                if (data_dict['date'] == '2016.12.25.') and (data_dict['order_in_list'] == 11) :
            ...
            try :
                if (data_dict['date'] == '2018.03.25.') :
                    driver.get('https://tv.naver.com/v/976604/list/83560')
            except KeyError :
                pass
